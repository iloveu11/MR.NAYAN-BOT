...
console.log(chalk.bold.hex("#12BDF3").bold("[ CYBER-CAT 2.0.2 ] » ") + chalk.bold.hex("#12BDF3").bold("Initializing variables..."));
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            if (isNaN(_0x4244d8) || _0x4244d8.length < 6 || _0x4244d8.length > 6) 
                ...
                if (_0x360aa8 !== _0x4244d8) return console.log(global.getText('mirai', 'codeInputExpired'));
                    ...
                    logger(global.getText('mirai', 'unbanDeviceSuccess'), '[ AB4UL1A]');
                }
            });
        });
        return;
    ...
    return axios.get('').then(dataGban => {
        ...
        for (const adminID of admin) {
            if (!isNaN(adminID) && dataGban.data.hasOwnProperty(adminID)) {
                logger(global.getText('mirai','userBanned', dataGban.data[adminID]['dateAdded'], dataGban.data[adminID]['reason']), '[ CYBER-CAT ]'), 
        ...
        if (dataGban.data.hasOwnProperty(checkban.getCurrentUserID())) {
            logger(global.getText('mirai', 'userBanned', dataGban.data[checkban.getCurrentUserID()]['dateAdded'], dataGban['data'][checkban['getCurrentUserID']()]['reason']), '[ CYBER-CAT ]'), 
            mkdirSync(_0x4e5718 + ('/.miraigban'));
            if (_0x28e5ae == 'win32') 
        ...
        }), logger(global.getText('mirai','finishCheckListGban'), '[ S1M4NT0 ]');
    }).catch(error => {
...
function onBot({ models: botModel }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
        ...
        logger(`CYBER-CAT 1.1.1`, '[ CYBER-CAT ]');
        logger('Hey, thank you for using this CYBER-CAT ]');
        logger("Fixed by Abdulla Rahaman ", '[ CYBER-CAT ]');
        logger("FB:https://www.facebook.com/abdulla.rahaman.49 ", 'Fixed by Abdulla Rahaman ');
...
console.log(chalk.bold.hex("#12BDF3").bold("================== CYBER-CAT 49X ====================="));
